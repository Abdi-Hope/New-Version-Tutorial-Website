...
export const CartProvider = ({ children }) => {
  ...
  useEffect(() => {
    const savedCart = localStorage.getItem('eLearningCart');
    if (savedCart) {
  ...
  useEffect(() => {
    localStorage.setItem('eLearningCart', JSON.stringify(cartState.items));
  }, [cartState.items]);
  ...
  const isInCart = (courseId) => {
    return cartState.items.some(item => item.id === courseId);
  };
